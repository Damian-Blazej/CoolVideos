            ...
            <div class="bg-light shadow px-5 py-5 text-primary d-flex justify-content-center align-items-center flex-column">
                    <div class="form-group">
                        ...
                        <div v-if="$v.credential.email.$error">
                            ...
                            <div class="text-danger" v-if="!$v.credential.email.minLength">Email musi zawierać conajmniej 5 znaków.</div>
                            <div class="text-danger" v-if="!$v.credential.email.maxLength">Email może zawierać conajwyżej 35 znaków.</div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div v-if="$v.credential.firstName.$error">
                            ...
                            <div class="text-danger" v-if="!$v.credential.firstName.minLength">Imię musi zawierać conajmniej 3 litery.</div>
                            <div class="text-danger" v-if="!$v.credential.firstName.maxLength">Imię może zawierać conajwyżej 15 liter.</div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div v-if="$v.credential.lastName.$error">
                            <div class="text-danger" v-if="!$v.credential.lastName.required">Nazwisko jest wymagane.</div>
                            <div class="text-danger" v-if="!$v.credential.lastName.minLength">Nazwisko musi zawierać conajmniej 3 litery.</div>
                            <div class="text-danger" v-if="!$v.credential.lastName.maxLength">Nazwisko może zawierać conajwyżej 20 liter.</div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div v-if="$v.credential.password.$error">
                            ...
                            <div class="text-danger" v-if="!$v.credential.password.minLength">Nazwisko musi zawierać conajmniej 6 znaków.</div>
                        </div>
                    </div>
                <div class="mt-3 w-75">
                    <b-button @click="register" variant="outline-warning" block squared>Zarejestruj się</b-button>
        ...
        methods: {
            register() {
                ...
                if (this.$v.$invalid) {
                    ...
                    this.$http.post(this.$serverUrl + '/api/user', this.credential).then(resoult => {
